...
const DashboardHome = () => {
    ...
    const deleteCat = async (id, name) => {
        const confirmDelete = window.confirm(` هل انت متأكد من أنك تريد حذف هذه الفئة : ${name}. اذا قمت بحذفها سيتم حذف جيمع المواقع التي تحتويها.`);
        if (confirmDelete) {
            try {
  ...
  return (
    <div className=' md:flex  gap-14 '>
        <SideBar />
        <div className=''>
            <h1 className='items-center justify-center text-center text-3xl'>اهلا بك في لوحة التكحم</h1>
            <div className='items-center justify-center text-center'>
                <h1 className='text-xl mb-4'>هنا بأمكانك اضافة ,تعديل وحذف الفئات</h1>
